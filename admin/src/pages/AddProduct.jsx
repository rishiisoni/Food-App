...
import axios from 'axios'  //this will help to do the api call
...
export default function AddProduct ({url}) {
    ...
    const handleSumbit = async (event) => {
        ...
        const response = await axios.post(`${url}/api/food/addproduct`, formData);
    ...
    return (
        <div className="add">
            <form className="flex-col" onSubmit={handleSumbit}>
                ...
                <div className="add-product-description flex-col">
                    ...
                    <textarea onChange={handleChange} value={data.description} name="description" rows='6' placeholder='Write about the dish'></textarea>
                </div>
